...
Edit `.env` and add your [CardSight](https://cardsight.ai/) API key to enable AI-powered card identification from uploaded photos. Sign up at [cardsight.ai](https://cardsight.ai/) to get a key. The app works without it — you'll just fill in card details manually.
